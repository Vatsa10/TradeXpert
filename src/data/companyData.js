export const COMPANY_DATA = {
  MSFT: {
    ...
    predictive: {
      ...
      risk_level: 'Low',
      historical_data: [
        { Date: new Date(2024, 10, 1).getTime(), Close: 409.00 },
    { Date: new Date(2024, 11, 2).getTime(), Close: 418.16 },
    { Date: new Date(2024, 12, 3).getTime(), Close: 416.22 },
    { Date: new Date(2025, 1, 4).getTime(), Close: 411.65 },
    { Date: new Date(2025, 2, 5).getTime(), Close: 402.99 },
    { Date: new Date(2025, 3, 6).getTime(), Close: 359.84 },
    { Date: new Date(2025, 4, 15).getTime(), Close: 448.83 }
      ],
      predicted_data: [
    { Date: new Date(2025, 4, 15).getTime(), Close: 448.83 },
    { Date: new Date(2025, 4, 30).getTime(), Close: 453.84 },
    { Date: new Date(2025, 5, 14).getTime(), Close: 458.85 },
    { Date: new Date(2025, 5, 29).getTime(), Close: 463.87 },
    { Date: new Date(2025, 6, 14).getTime(), Close: 468.88 },
    { Date: new Date(2025, 6, 29).getTime(), Close: 473.89 },
    { Date: new Date(2025, 7, 14).getTime(), Close: 478.90 },
    { Date: new Date(2025, 7, 29).getTime(), Close: 483.92 },
    { Date: new Date(2025, 8, 13).getTime(), Close: 488.93 },
    { Date: new Date(2025, 8, 28).getTime(), Close: 493.94 },
    { Date: new Date(2025, 9, 13).getTime(), Close: 498.95 },
    { Date: new Date(2025, 9, 28).getTime(), Close: 503.97 },
    { Date: new Date(2025, 10, 12).getTime(), Close: 508.98 },
    { Date: new Date(2025, 10, 27).getTime(), Close: 513.99 },
    { Date: new Date(2025, 11, 12).getTime(), Close: 519.00 },
    { Date: new Date(2025, 11, 27).getTime(), Close: 524.02 },
    { Date: new Date(2026, 0, 11).getTime(), Close: 529.03 },
    { Date: new Date(2026, 0, 26).getTime(), Close: 534.04 },
    { Date: new Date(2026, 1, 10).getTime(), Close: 539.05 },
    { Date: new Date(2026, 1, 25).getTime(), Close: 544.07 },
    { Date: new Date(2026, 2, 12).getTime(), Close: 549.08 },
    { Date: new Date(2026, 2, 27).getTime(), Close: 554.09 },
    { Date: new Date(2026, 3, 11).getTime(), Close: 559.10 },
    { Date: new Date(2026, 3, 26).getTime(), Close: 564.12 },
    { Date: new Date(2026, 4, 11).getTime(), Close: 569.13 }
      ]
    }
  },
  AAPL: {
  ...
  AMZN: {
    ...
    predictive: {
      ...
      risk_level: 'Medium',
      historical_data: [
    { Date: new Date(2024, 10, 1).getTime(), Close: 197.93 },
    { Date: new Date(2024, 11, 2).getTime(), Close: 208.18 },
    { Date: new Date(2024, 12, 3).getTime(), Close: 208.36 },
    { Date: new Date(2025, 1, 4).getTime(), Close: 242.04 },
    { Date: new Date(2025, 2, 5).getTime(), Close: 195.99 },
    { Date: new Date(2025, 3, 6).getTime(), Close: 161.00 },
    { Date: new Date(2025, 4, 15).getTime(), Close: 209.00 }
      ],
      predicted_data: [
    { Date: new Date(2025, 4, 15).getTime(), Close: 209.00 },
    { Date: new Date(2025, 4, 30).getTime(), Close: 211.17 },
    { Date: new Date(2025, 5, 14).getTime(), Close: 213.33 },
    { Date: new Date(2025, 5, 29).getTime(), Close: 215.50 },
    { Date: new Date(2025, 6, 14).getTime(), Close: 217.66 },
    { Date: new Date(2025, 6, 29).getTime(), Close: 219.83 },
    { Date: new Date(2025, 7, 14).getTime(), Close: 222.00 },
    { Date: new Date(2025, 7, 29).getTime(), Close: 224.16 },
    { Date: new Date(2025, 8, 13).getTime(), Close: 226.33 },
    { Date: new Date(2025, 8, 28).getTime(), Close: 228.49 },
    { Date: new Date(2025, 9, 13).getTime(), Close: 230.66 },
    { Date: new Date(2025, 9, 28).getTime(), Close: 232.83 },
    { Date: new Date(2025, 10, 12).getTime(), Close: 234.99 },
    { Date: new Date(2025, 10, 27).getTime(), Close: 237.16 },
    { Date: new Date(2025, 11, 12).getTime(), Close: 239.32 },
    { Date: new Date(2025, 11, 27).getTime(), Close: 241.49 },
    { Date: new Date(2026, 0, 11).getTime(), Close: 243.66 },
    { Date: new Date(2026, 0, 26).getTime(), Close: 245.82 },
    { Date: new Date(2026, 1, 10).getTime(), Close: 247.99 },
    { Date: new Date(2026, 1, 25).getTime(), Close: 250.15 },
    { Date: new Date(2026, 2, 12).getTime(), Close: 252.32 },
    { Date: new Date(2026, 2, 27).getTime(), Close: 254.49 },
    { Date: new Date(2026, 3, 11).getTime(), Close: 256.65 },
    { Date: new Date(2026, 3, 26).getTime(), Close: 258.82 },
    { Date: new Date(2026, 4, 11).getTime(), Close: 260.99 }
      ]
    }
  },
  TSLA: {
    ...
    predictive: {
      ...
      risk_level: 'High',
      historical_data: [
    { Date: new Date(2024, 10, 1).getTime(), Close: 424.77 },
    { Date: new Date(2024, 11, 2).getTime(), Close: 416.15 },
    { Date: new Date(2024, 12, 3).getTime(), Close: 405.79 },
    { Date: new Date(2025, 1, 4).getTime(), Close: 355.84 },
    { Date: new Date(2025, 2, 5).getTime(), Close: 298.26 },
    { Date: new Date(2025, 3, 6).getTime(), Close: 214.00 },
    { Date: new Date(2025, 4, 15).getTime(), Close: 346.60 }
      ],
      predicted_data: [
    { Date: new Date(2025, 4, 15).getTime(), Close: 346.60 },
    { Date: new Date(2025, 4, 30).getTime(), Close: 352.53 },
    { Date: new Date(2025, 5, 14).getTime(), Close: 358.47 },
    { Date: new Date(2025, 5, 29).getTime(), Close: 364.40 },
    { Date: new Date(2025, 6, 14).getTime(), Close: 370.34 },
    { Date: new Date(2025, 6, 29).getTime(), Close: 376.27 },
    { Date: new Date(2025, 7, 14).getTime(), Close: 382.21 },
    { Date: new Date(2025, 7, 29).getTime(), Close: 388.14 },
    { Date: new Date(2025, 8, 13).getTime(), Close: 394.08 },
    { Date: new Date(2025, 8, 28).getTime(), Close: 400.01 },
    { Date: new Date(2025, 9, 13).getTime(), Close: 405.95 },
    { Date: new Date(2025, 9, 28).getTime(), Close: 411.88 },
    { Date: new Date(2025, 10, 12).getTime(), Close: 417.82 },
    { Date: new Date(2025, 10, 27).getTime(), Close: 423.75 },
    { Date: new Date(2025, 11, 12).getTime(), Close: 429.69 },
    { Date: new Date(2025, 11, 27).getTime(), Close: 435.62 },
    { Date: new Date(2026, 0, 11).getTime(), Close: 441.56 },
    { Date: new Date(2026, 0, 26).getTime(), Close: 447.49 },
    { Date: new Date(2026, 1, 10).getTime(), Close: 453.43 },
    { Date: new Date(2026, 1, 25).getTime(), Close: 459.36 },
    { Date: new Date(2026, 2, 12).getTime(), Close: 465.30 },
    { Date: new Date(2026, 2, 27).getTime(), Close: 471.23 },
    { Date: new Date(2026, 3, 11).getTime(), Close: 477.17 },
    { Date: new Date(2026, 3, 26).getTime(), Close: 483.10 },
    { Date: new Date(2026, 4, 11).getTime(), Close: 489.04 }
      ]
    }
  },
  GOOGL: {
    ...
    predictive: {
      ...
      risk_level: 'Low',
      historical_data: [
    { Date: new Date(2024, 10, 1).getTime(), Close: 168.95 },
    { Date: new Date(2024, 11, 2).getTime(), Close: 189.30 },
    { Date: new Date(2024, 12, 3).getTime(), Close: 204.02 },
    { Date: new Date(2025, 1, 4).getTime(), Close: 207.78 },
    { Date: new Date(2025, 2, 5).getTime(), Close: 154.64 },
    { Date: new Date(2025, 3, 6).getTime(), Close: 158.80 },
    { Date: new Date(2025, 4, 15).getTime(), Close: 164.66 }
      ],
      predicted_data: [
    { Date: new Date(2025, 4, 15).getTime(), Close: 164.66 },
    { Date: new Date(2025, 4, 30).getTime(), Close: 168.01 },
    { Date: new Date(2025, 5, 14).getTime(), Close: 171.36 },
    { Date: new Date(2025, 5, 29).getTime(), Close: 174.71 },
    { Date: new Date(2025, 6, 14).getTime(), Close: 178.06 },
    { Date: new Date(2025, 6, 29).getTime(), Close: 181.41 },
    { Date: new Date(2025, 7, 14).getTime(), Close: 184.76 },
    { Date: new Date(2025, 7, 29).getTime(), Close: 188.11 },
    { Date: new Date(2025, 8, 13).getTime(), Close: 191.46 },
    { Date: new Date(2025, 8, 28).getTime(), Close: 194.81 },
    { Date: new Date(2025, 9, 13).getTime(), Close: 198.16 },
    { Date: new Date(2025, 9, 28).getTime(), Close: 201.51 },
    { Date: new Date(2025, 10, 12).getTime(), Close: 204.86 },
    { Date: new Date(2025, 10, 27).getTime(), Close: 208.21 },
    { Date: new Date(2025, 11, 12).getTime(), Close: 211.56 },
    { Date: new Date(2025, 11, 27).getTime(), Close: 214.91 },
    { Date: new Date(2026, 0, 11).getTime(), Close: 218.26 },
    { Date: new Date(2026, 0, 26).getTime(), Close: 221.61 },
    { Date: new Date(2026, 1, 10).getTime(), Close: 224.96 },
    { Date: new Date(2026, 1, 25).getTime(), Close: 228.31 },
    { Date: new Date(2026, 2, 12).getTime(), Close: 231.66 },
    { Date: new Date(2026, 2, 27).getTime(), Close: 235.01 },
    { Date: new Date(2026, 3, 11).getTime(), Close: 238.36 },
    { Date: new Date(2026, 3, 26).getTime(), Close: 241.71 },
    { Date: new Date(2026, 4, 11).getTime(), Close: 245.06 }
      ]
    }
  },
  META: {
    ...
    predictive: {
      ...
      risk_level: 'Medium',
      historical_data: [
    { Date: new Date(2024, 10, 1).getTime(), Close: 574.32 },
    { Date: new Date(2024, 11, 2).getTime(), Close: 585.51 },
    { Date: new Date(2024, 12, 3).getTime(), Close: 689.18 },
    { Date: new Date(2025, 1, 4).getTime(), Close: 668.20 },
    { Date: new Date(2025, 2, 5).getTime(), Close: 576.36 },
    { Date: new Date(2025, 3, 6).getTime(), Close: 549.00 },
    { Date: new Date(2025, 4, 15).getTime(), Close: 641.35 }
      ],
      predicted_data: [
    { Date: new Date(2025, 4, 15).getTime(), Close: 641.35 },
    { Date: new Date(2025, 4, 30).getTime(), Close: 650.25 },
    { Date: new Date(2025, 5, 14).getTime(), Close: 659.15 },
    { Date: new Date(2025, 5, 29).getTime(), Close: 668.05 },
    { Date: new Date(2025, 6, 14).getTime(), Close: 676.95 },
    { Date: new Date(2025, 6, 29).getTime(), Close: 685.85 },
    { Date: new Date(2025, 7, 14).getTime(), Close: 694.75 },
    { Date: new Date(2025, 7, 29).getTime(), Close: 703.65 },
    { Date: new Date(2025, 8, 13).getTime(), Close: 712.55 },
    { Date: new Date(2025, 8, 28).getTime(), Close: 721.45 },
    { Date: new Date(2025, 9, 13).getTime(), Close: 730.36 },
    { Date: new Date(2025, 9, 28).getTime(), Close: 739.26 },
    { Date: new Date(2025, 10, 12).getTime(), Close: 748.16 },
    { Date: new Date(2025, 10, 27).getTime(), Close: 757.06 },
    { Date: new Date(2025, 11, 12).getTime(), Close: 765.96 },
    { Date: new Date(2025, 11, 27).getTime(), Close: 774.86 },
    { Date: new Date(2026, 0, 11).getTime(), Close: 783.76 },
    { Date: new Date(2026, 0, 26).getTime(), Close: 792.66 },
    { Date: new Date(2026, 1, 10).getTime(), Close: 801.56 },
    { Date: new Date(2026, 1, 25).getTime(), Close: 810.46 },
    { Date: new Date(2026, 2, 12).getTime(), Close: 819.36 },
    { Date: new Date(2026, 2, 27).getTime(), Close: 828.27 },
    { Date: new Date(2026, 3, 11).getTime(), Close: 837.17 },
    { Date: new Date(2026, 3, 26).getTime(), Close: 846.07 },
    { Date: new Date(2026, 4, 11).getTime(), Close: 854.97 }
      ]
    }
  },
  NVDA: {
    ...
    predictive: {
      ...
      risk_level: 'High',
      historical_data: [
    { Date: new Date(2024, 10, 1).getTime(), Close: 135.74 }, // Nov 2024 avg, real-time data
    { Date: new Date(2024, 11, 2).getTime(), Close: 136.04 }, // Dec 2024 avg, real-time data
    { Date: new Date(2024, 12, 3).getTime(), Close: 149.00 }, // Jan 2025 avg, near $149.42 [Web:18]
    { Date: new Date(2025, 1, 4).getTime(), Close: 141.00 }, // Feb 2025 avg, real-time data
    { Date: new Date(2025, 2, 5).getTime(), Close: 107.76 }, // Mar 2025 avg, real-time data
    { Date: new Date(2025, 3, 6).getTime(), Close: 94.00 }, // Apr 2025 avg, real-time data
    { Date: new Date(2025, 4, 15).getTime(), Close: 129.77 }
      ],
      predicted_data: [
    { Date: new Date(2025, 4, 15).getTime(), Close: 129.77 }, // Starting point, real-time data
    { Date: new Date(2025, 4, 30).getTime(), Close: 131.81 }, // Interpolated to $180.327
    { Date: new Date(2025, 5, 14).getTime(), Close: 133.85 }, // +$2.04 per 15 days
    { Date: new Date(2025, 5, 29).getTime(), Close: 135.89 },
    { Date: new Date(2025, 6, 14).getTime(), Close: 137.93 },
    { Date: new Date(2025, 6, 29).getTime(), Close: 139.97 },
    { Date: new Date(2025, 7, 14).getTime(), Close: 142.01 },
    { Date: new Date(2025, 7, 29).getTime(), Close: 144.05 },
    { Date: new Date(2025, 8, 13).getTime(), Close: 146.09 },
    { Date: new Date(2025, 8, 28).getTime(), Close: 148.13 },
    { Date: new Date(2025, 9, 13).getTime(), Close: 150.17 },
    { Date: new Date(2025, 9, 28).getTime(), Close: 152.21 },
    { Date: new Date(2025, 10, 12).getTime(), Close: 154.25 },
    { Date: new Date(2025, 10, 27).getTime(), Close: 156.29 },
    { Date: new Date(2025, 11, 12).getTime(), Close: 158.33 },
    { Date: new Date(2025, 11, 27).getTime(), Close: 160.37 },
    { Date: new Date(2026, 0, 11).getTime(), Close: 162.41 },
    { Date: new Date(2026, 0, 26).getTime(), Close: 164.45 },
    { Date: new Date(2026, 1, 10).getTime(), Close: 166.49 },
    { Date: new Date(2026, 1, 25).getTime(), Close: 168.53 },
    { Date: new Date(2026, 2, 12).getTime(), Close: 170.57 },
    { Date: new Date(2026, 2, 27).getTime(), Close: 172.61 },
    { Date: new Date(2026, 3, 11).getTime(), Close: 174.65 },
    { Date: new Date(2026, 3, 26).getTime(), Close: 176.69 },
    { Date: new Date(2026, 4, 11).getTime(), Close: 178.73 }
      ]
    }
  },
